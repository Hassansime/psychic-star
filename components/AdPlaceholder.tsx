...
export const AdPlaceholder: React.FC<AdPlaceholderProps> = ({ variant = 'banner' }) => {
  return (
    <div className={`relative overflow-hidden group ${
      variant === 'banner' ? 'w-full h-24' : 'w-full h-64'
    } bg-slate-900/30 border border-slate-700/30 rounded-lg flex items-center justify-center`}>
      ...
      <div className="text-center z-10">
        <span className="text-xs font-mono uppercase tracking-widest text-slate-600 block mb-1">Sponsored</span>
