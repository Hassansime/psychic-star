...
export const DisclaimerModal: React.FC<DisclaimerModalProps> = ({ onConsent }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="glass-panel max-w-md w-full rounded-2xl p-8 shadow-2xl border-t border-white/10">
        ...
        <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
          <p>
            <strong className="text-white">Educational Purpose:</strong> We use advanced archetypal pattern recognition to reveal psychological insights. We provide guidance, not prediction.
          </p>
          <p>
          ...
          <p>
            <strong className="text-white">Privacy First:</strong> Your entries are sent to our sanctuary solely for the purpose of this reading. We do not sell your personal data.
          </p>
