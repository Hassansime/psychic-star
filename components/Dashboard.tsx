            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between px-2">
                {MOOD_ICONS.map((icon, idx) => (
                  ...
                  >
                    <span className="text-2xl filter grayscale group-hover:grayscale-0 transition-all duration-300 transform group-hover:scale-125 group-hover:drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]">{icon}</span>
                    <span className="text-[10px] text-slate-600 group-hover:text-accent-indigo transition-colors duration-300">{MOOD_LABELS[idx]}</span>
                  </button>
                ))}
              </div>
            </div>
      ...
      <section>
         <div className="flex items-center gap-2 mb-6 text-slate-300">
          ...
          <div className="space-y-4 relative pl-8 border-l border-slate-800 ml-4">
            {readings.length === 0 && (
              <div className="text-slate-500 text-sm italic pl-4">No consultations recorded yet. Begin your journey with us.</div>
            )}
                 ...
                 <div 
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                       <h4 className="font-serif text-white text-lg">"{reading.energeticOverview.symbolic}"</h4>
